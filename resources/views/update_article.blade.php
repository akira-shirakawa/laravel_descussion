        ...
        @include('common.error') 
            <form method="post" action="{{route('articles.store')}}">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" placeholder="タイトル" name="title" value="{{$article->title}}" required>
                    </div>
                </div>
                <div class="field">
                    <label class="label">詳細</label>
                    <div class="control">
                        <textarea class="textarea" placeholder="本文" name="detail">{{$article->detail}}</textarea>
                    </div>
                </div>
                カテゴリー
                <div class="select ">
